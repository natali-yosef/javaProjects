...
public class BallCollisionCountdownAgent extends GameObject {
    ...
    private final int startCollisionBall;
    ...
    public BallCollisionCountdownAgent(Ball ball, ChangeCameraStrategy owner, int countDownValue) {
        super(Vector2.ZERO, Vector2.ZERO, new TextRenderable(""));
        this.ball = ball;
        this.owner = owner;
        this.countDownValue = countDownValue;
        this.startCollisionBall = ball.getCollisionCount();
    }
    ...
    public void update(float deltaTime) {
        ...
        if (countDownValue <= (ball.getCollisionCount() - startCollisionBall)){
